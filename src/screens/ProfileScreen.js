...
const ProfileScreen = ({navigation}) => {
  ...
  const icon = (name) => {
    return (
      <AntDesign name={name} size={16} color='white' />
    )
  }

  const getProfile = () => {
    setprofile({
      picture: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2070&q=80',
      name: 'Peperoni Pizza',
      city: 'Tampere',
      ...
      <View style={styles.container}>
        ...
        {!editMode ? (
          ...
          <View style={styles.details} >
            <View style={styles.detailRow}>
              <Text style={styles.leftText}>City:</Text>
              <TextInput value={city} onChangeText={text=>setcity(text)} style={styles.textInput} />
            </View>
            <View style={styles.detailRow}>
              <Text style={styles.leftText}>Email:</Text>
            ...
            <View style={styles.detailRow}>
              <Text style={styles.leftText}>Fav Food:</Text>
              <TextInput value={favorite} onChangeText={text=>setfavorite(text)} style={styles.textInput} />
            </View>
          </View>
        ) }
      </View>
