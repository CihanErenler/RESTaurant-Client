...
import { StyleSheet, Text, View, Modal, SafeAreaView, Image, Dimensions, ScrollView } from 'react-native';
        ...
        <View style={styles.widthcont}>
          ...
          <View style={styles.cardwrapper}>
            <View style={styles.cardline}>
              <View style={[styles.card, { borderColor: colors.primary, marginRight: spacings.s4}]}>
                <View style={styles.imgcontainer}>
                  <Image style={styles.image} source={require('../../assets/images/cat.jpg')} resizeMode="cover" />
                </View>
                <View style={styles.titleWrap}>
                  <Text style={styles.name}>Anna Kot</Text>
                </View>
              </View>
              <View style={[styles.card, { borderColor: colors.secondary, marginLeft: spacings.s4}]}>
                <View style={styles.imgcontainer}>
                  <Image style={styles.image} source={require('../../assets/images/dog.jpg')} resizeMode="cover" />
                </View>
                <View style={styles.titleWrap}>
            ...
            <View style={styles.cardline}>
              <View style={[styles.card, { borderColor: colors.support, marginRight: spacings.s4}]}>
                <View style={styles.imgcontainer}>
                  <Image style={styles.image} source={require('../../assets/images/hedge.jpg')} resizeMode="cover" />
                </View>
                <View style={styles.titleWrap}>
                  <Text style={styles.name}>Rachmad Fauzan</Text>
                </View>
              </View>
              <View style={[styles.card, { borderColor: colors.accent, marginLeft: spacings.s4}]}>
                <View style={styles.imgcontainer}>
                  <Image style={styles.image} source={require('../../assets/images/puff.jpg')} resizeMode="cover" />
                </View>
                <View style={styles.titleWrap}>
